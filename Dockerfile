...
COPY wb_proxy.py wb_accounts.py wb_catalog.py wb_fingerprint.py wb_scheduler.py wb_tasks.py wb_settings.py wb_identity.py wb_webtools.py dashboard.html ./
